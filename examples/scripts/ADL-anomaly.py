...
# standalone environment. In real world applications the stream data can be
# fed into the anomaly detector using data pipeline
#
...
source_data = '/home/ai/adl/source_data/anomaly'
...
# You can integrate anomaly detection application into an ML pipeline by
# leveraging the callback function below
